    ...
    <div className="min-h-screen bg-[#0a0a0f] px-6 py-16">
      <div className="max-w-[800px] mx-auto">
        ...
        <Section title="6. Music Licensing">
          <p>Music tracks available through the Service are subject to the licensing terms of the applicable catalog provider. Users are responsible for ensuring their use of any track complies with the requirements of the relevant platform (such as YouTube, TikTok, or Instagram) and applicable law. Backbeat makes no warranties regarding the clearance status of specific tracks for any particular use. For commercial broadcast, film, television, or advertising use, please verify licensing directly with the catalog provider before using any track.</p>
